...
namespace DPM.Infrastructure.Migrations
{
    ...
    [Migration("20240229100517_InitialCreate")]
            ...
            modelBuilder.Entity("DPM.Domain.Entities.FishingTrip", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_fishing_trips");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("ix_fishing_trips_created_by");

                    b.HasIndex("ShipId")
                        .HasDatabaseName("ix_fishing_trips_ship_id");

                    b.HasIndex("UpdatedBy")
                        .HasDatabaseName("ix_fishing_trips_updated_by");

                    b.ToTable("fishing_trips", (string)null);
                });
            ...
            modelBuilder.Entity("DPM.Domain.Entities.CertificateShip", b =>
                {
                    b.HasOne("DPM.Domain.Entities.FishingTrip", "FishingTrip")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_certificate_ships_fishing_trips_fishing_trip_id");
            ...
            modelBuilder.Entity("DPM.Domain.Entities.Fishermen", b =>
                {
                    b.HasOne("DPM.Domain.Entities.FishingTrip", null)
                        .WithMany("Crews")
                        .HasForeignKey("FishingTripId")
                        .HasConstraintName("fk_fishermens_fishing_trips_fishing_trip_id");
                });
            ...
            modelBuilder.Entity("DPM.Domain.Entities.FishingTrip", b =>
                {
                    b.HasOne("DPM.Domain.Entities.User", "Creator")
                        ...
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_fishing_trips_user_creator_id");
                    ...
                    b.HasOne("DPM.Domain.Entities.FishingTripHistory", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fishing_trips_fishing_trip_history_id");
                    ...
                    b.HasOne("DPM.Domain.Entities.Ship", "Ship")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fishing_trips_ship_ship_id");

                    b.HasOne("DPM.Domain.Entities.User", "Updater")
                        .WithMany()
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_fishing_trips_user_updater_id");
