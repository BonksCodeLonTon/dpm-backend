...
namespace DPM.Infrastructure.Migrations
{
    ...
    [Migration("20240302010946_Init5")]
    partial class Init5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DPM.Domain.Entities.ShipRegistry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DPM.Domain.Entities.FishingTrip", b =>
                {
                    b.HasOne("DPM.Domain.Entities.User", "Creator")
                        ...
                        .HasConstraintName("fk_fishing_trip_users_creator_id");
                    ...
                    b.HasOne("DPM.Domain.Entities.Ship", "Ship")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fishing_trip_ships_ship_id");

                    b.HasOne("DPM.Domain.Entities.User", "Updater")
                        .WithMany()
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_fishing_trip_users_updater_id");
