...
namespace DPM.Infrastructure.Migrations
{
    ...
    [Migration("20240307025313_UpdateGenerateIdFunc")]
    partial class UpdateGenerateIdFunc
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DPM.Domain.Entities.RegisterToArrival", b =>
                {
                    ...
                    b.Property<long>("RegisterById")
                        .HasColumnType("bigint")
                        .HasColumnName("register_by_id");
            ...
            modelBuilder.Entity("DPM.Domain.Entities.RegisterToArrival", b =>
                {
                    ...
                    b.HasOne("DPM.Domain.Entities.Ship", "Ship")
                        .WithOne()
                        .HasForeignKey("DPM.Domain.Entities.RegisterToArrival", "ShipId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DPM.Domain.Entities.RegisterToDeparture", b =>
                {
                    ...
                    b.HasOne("DPM.Domain.Entities.Ship", "Ship")
                        .WithOne()
                        .HasForeignKey("DPM.Domain.Entities.RegisterToDeparture", "ShipId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
