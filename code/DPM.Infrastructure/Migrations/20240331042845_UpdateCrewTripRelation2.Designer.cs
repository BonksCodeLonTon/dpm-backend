...
namespace DPM.Infrastructure.Migrations
{
    ...
    [Migration("20240331042845_UpdateCrewTripRelation2")]
    partial class UpdateCrewTripRelation2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DPM.Domain.Entities.CrewTrip", b =>
                {
                    ...
                    b.HasIndex("RegisterToArrivalArrivalId")
                        .HasDatabaseName("ix_crew_trip_register_to_arrival_arrival_id");

                    b.HasIndex("RegisterToDepartureDepartureId")
                        .HasDatabaseName("ix_crew_trip_register_to_departure_departure_id");
            ...
            modelBuilder.Entity("DPM.Domain.Entities.CrewTrip", b =>
                {
                    ...
                    b.HasOne("DPM.Domain.Entities.ArrivalRegistration", "RegisterToArrival")
                        ...
                        .HasConstraintName("fk_crew_trip_arrival_registration_register_to_arrival_temp_id1");

                    b.HasOne("DPM.Domain.Entities.DepartureRegistration", "RegisterToDeparture")
                        .WithMany()
                        .HasForeignKey("RegisterToDepartureDepartureId")
                        .HasConstraintName("fk_crew_trip_departure_registration_register_to_departure_temp");
